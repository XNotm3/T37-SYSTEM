...
st.title("🧠 T37 PERSONALITY SYSTEM v6.6")
...
# === Tabs (todos los sliders actualizan st.session_state.values) ===
...
with tab1:
    ...
    with col_s:
        v["gen_heredada"] = st.slider("GENÉTICA HEREDADA", 0,100,v.get("gen_
